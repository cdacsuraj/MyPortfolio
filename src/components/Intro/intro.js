...
function Intro() {
  ...
  return (
    <section id='intro'>
      {/* <a href="https://www.linkedin.com/in/cdaciansuraj"><img src={LinkedIn} alt='linkedin' className='linkedinImg' onClick={()=>newTab('https://www.linkedin.com/in/cdaciansuraj')}/></a><br/>
      <a href="https://github.com/cdacsuraj"><img src={GitHub} alt='github' className='githubImg' onClick={()=>newTab('https://github.com/cdacsuraj')}/></a> */}
      
        <div className='introContent'>
            <span className='hello'>Hello,</span>
            <span className='introtext'>I'm <span className='introName'>Suraj Singh</span> <br/>Full-Stack Developer</span>
