...
const Navbar = () => {
  ...
  return (
    <nav className='navbar'>
        ...
        <a href="https://www.linkedin.com/in/cdaciansuraj"><img src={LinkedIn} alt='linkedin' className='linkedinImg' onClick={()=>newTab('https://www.linkedin.com/in/cdaciansuraj')}/></a>
